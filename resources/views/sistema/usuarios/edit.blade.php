                        ...
                        <div class="card-body border-top p-9">
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8">
                                    <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url({{ asset('/assets/media/avatars/blank.png') }})">
                                        <div class="image-input-wrapper w-125px h-125px" style="background-image: url({{ asset('storage/img/usuarios/' . $usuario->imagem) }})"></div>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="nome" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Nome" value="{{ $usuario->nome }}" />
                                    @error('nome')
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="user" class="form-control form-control-lg form-control-solid" placeholder="Usuario" value="{{ $usuario->user }}" />
                                    @error('user')
                                    <div class="fv-plugins-message-container invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <select name="sexo" data-control="select2" class="form-select form-select-solid form-select-lg fw-semibold">
                                        <option value="Masculino" {{ old('gender', $usuario->sexo) === 'Masculino' ? 'selected' : '' }}>Masculino</option>
                                        <option value="Feminino" {{ old('gender', $usuario->sexo) === 'Feminino' ? 'selected' : '' }}>Feminino</option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="card-body border-top p-9">
                                        ...
                                        <div class="row mb-6">
                                            <div class="col-lg-6 mb-4 mb-lg-0">
                                                <div class="fv-row mb-0">
                                                    ...
                                                    <input type="email" class="form-control form-control-lg form-control-solid" id="emailaddress" placeholder="Email Address" name="email" value="{{ $usuario->email }}" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="d-flex">
                            ...
                            <div class="d-flex flex-wrap align-items-center mb-10">
                                ...
                                <div id="kt_signin_password_edit" class="flex-row-fluid d-none">
                                    <form id="kt_signin_change_password" class="form" novalidate="novalidate" action="{{ route('usuarios.changePassword', $usuario->id) }}" method="POST">
                                        <div class="row mb-1">
                                            <div class="col-lg-4">
                                                <div class="fv-row mb-0">
