                    ...
                    <div class="app-navbar flex-shrink-0">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
                                <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('assets/media/misc/pattern-1.jpg')">
                                    <h3 class="text-white fw-semibold px-9 mt-10 mb-6">Notificações
                                        <span class="fs-8 opacity-75 ps-3">2 relatórios</span>
                                    </h3>
                        ...
                        <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                            <div class="cursor-pointer symbol symbol-35px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                                <img src="{{ Auth::user()->imagem ? asset('storage/img/usuarios/' . Auth::user()->imagem) : asset('assets/media/avatars/blank.png') }}" alt="{{ Auth::user()->nome }}" />
                            </div>
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                                <div class="menu-item px-3">
                                    <div class="menu-content d-flex align-items-center px-3">
                                        <div class="symbol symbol-50px me-5">
                                            <img alt="" src="{{ Auth::user()->imagem ? asset('storage/img/usuarios/' . Auth::user()->imagem) : asset('assets/media/avatars/blank.png') }}" />
                                        </div>
                                ...
                                <div class="menu-item px-5">
                                    <a href="{{ route('usuarios.edit', Auth::user()->id) }}" class="menu-link px-5">Meu Perfil</a>
                                </div>
                                ...
                                <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="left-start">
                                    <a href="#" class="menu-link px-5">
                                        <span class="menu-title position-relative">Linguagem
                                            <span class="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0">Brasil
                                                <img class="w-15px h-15px rounded-1 ms-2" src="{{ asset('/assets/media/flags/brazil.svg') }}" alt="" />
                                            </span>
                                        </span>
                                    </a>
