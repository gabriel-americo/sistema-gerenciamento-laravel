        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Clientes</h1>
                    ...
                    <div class="card-header border-0 pt-6">
                        <div class="card-title">
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kt-user-table-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Buscar Clientes" />
                            </div>
                        </div>
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex align-items-center">
                                        <div class="d-flex flex-column">
                                            <a href="{{ route('clientes.show', $cliente->id) }}" class="text-gray-800 text-hover-primary mb-1">{{ $cliente->nome . ' ' . $cliente->sobrenome }}</a>
                                    ...
                                    <td>{{ $cliente->user }}</td>
                                    <td>
                                        <div class="badge {{ $cliente->status == 'Ativo' ? 'badge-light-success' : 'badge-light-danger' }}">
                                            {{ $cliente->status }}
                                        </div>
                                    </td>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                            <div class="menu-item px-3">
                                                <a href="{{ route('clientes.edit', $cliente->id) }}" class="menu-link px-3">Editar</a>
                                            </div>

                                            <form class="menu-item px-3 sweetalert-delete" action="{{ route('clientes.destroy', $cliente->id) }}" method="POST">
                                                @csrf
                                                @method("DELETE")
