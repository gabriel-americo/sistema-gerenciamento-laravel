    ...
    var e, t, n, r, o = document.getElementById("kt_table_users"),
        c = () => {
            o.querySelectorAll('[data-kt-users-table-filter="delete_row"]').forEach((t => {
                t.addEventListener("click", (function(t) {
                    ...
                    Swal.fire({
                        text: "Tem certeza de que deseja excluir " + r + "?",
                        icon: "warning",
                        showCancelButton: !0,
                        buttonsStyling: !1,
        ...
        l = () => {
            ...
            c.forEach((e => {
                ...
                Swal.fire({
                    text: "Tem certeza de que deseja excluir os clientes selecionados?",
                    icon: "warning",
                    showCancelButton: !0,
                    buttonsStyling: !1,
                    confirmButtonText: "Sim, deletar!",
                    ...
                    t.value ? Swal.fire({
                        text: "Você excluiu todos os clientes selecionados!.",
                        icon: "success",
                        buttonsStyling: !1,
                        confirmButtonText: "Ok, entendi!",
                        customClass: {
